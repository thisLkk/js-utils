 ...
 */
function regIdCardName(name, callback) {
...
/**
 * @method regIdCardNametest
 * @description {@link https://jintingyou.com?sdkId=getAutoCheckResult|【点击获取二维码】}[正则] 校验中国身份证姓名格式
 * @version 0.0.1
 * @param {String} name - 必填项，身份证姓名（包含少数名族 · 格式，最大长度不超过20位）
 * @param {regIdCardNametestCallback} callback - 回调函数
 * @example
 *  const text = "鲁宽宽";
 *  function callback(res) {
 *    if (code == 0) {
...
export { regIdCardName as a, regIdCardNametest as b, index as default };
